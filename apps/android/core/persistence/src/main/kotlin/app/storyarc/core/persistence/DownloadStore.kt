...
class DownloadStore internal constructor(
     ...
     */
    fun location(id: String, extension: String): File =
        File(directory, "${id.replace(Regex("[^A-Za-z0-9._-]"), "-")}.$extension")
     ...
     */
    fun bytesOnDisk(): Long = directory.listFiles()?.sumOf { it.length() } ?: 0L
