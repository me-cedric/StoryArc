    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            StoryArcTheme(appearance = settings.appearance, useDynamicColor = true) {
                ...
                // Which source the open browser came from, so the rail can light the item
                // that led there. Held rather than read back off the page: a catalogue
                // page carries an address and a title, and no way home to the registry.
